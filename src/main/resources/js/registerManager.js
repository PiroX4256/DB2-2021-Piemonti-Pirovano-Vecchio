$(document).ready(function() {
    $("#register-button").on("click", function (e) {
        ...
        if(form.checkValidity()) {
            ...
            let formData = {username: username, email: email, passwordHash: document.getElementById("register-psw").value,
                passwordRepeatHash: document.getElementById("register-psw-repeat").value};
            $.ajax({
                type: "POST",
                url: 'register',
